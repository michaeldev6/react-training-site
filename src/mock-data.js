...
export function fetchUserData() {
  ...
  // Step 9-7: Intentionally mess up the route used so that we can see the ErrorListBoundary component in action
  return fetch('https://jsonplaceholder.typicode.com/somerandomroutethatdoesntexist')
